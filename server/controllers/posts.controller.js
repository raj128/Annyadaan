...
export const createPost =(req, res) => {
    const {title,venue,city,food_tags,meal_size,postedBy,img_url,expirey_date} = req.body;
    
    if (!title||!venue||!city||!food_tags||!meal_size||!img_url||!expirey_date) {
		return res.json({
